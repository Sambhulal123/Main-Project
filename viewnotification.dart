...
//
//   @override
//   State<Viewnotification> createState() => MyViewfriendlistPage();
// }
//
// class MyViewfriendlistPage extends State<Viewnotification> {
...
//       String url = '$urls/user_viewnotification/';
//
...
//
//                                     final urls =
//                                         Uri.parse('$url/accept_notification/');
//                                     try {
//                                       final response =
...
//
//                                     final urls =
//                                     Uri.parse('$url/reject_notification/');
//                                     try {
//                                       final response =
//                                           await http.post(urls, body: {
//                                         'nid': id_[index],
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.notifications_none_rounded, color: Colors.white, size: 50),
            ),
            SizedBox(height: 24),
            Text(
              "No Notifications",
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          return Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(Icons.photo_library_rounded, color: Colors.grey[600], size: 40),
                                SizedBox(height: 8),
                                Text(
                                  'Post Image',
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                final urls = Uri.parse('$url/accept_notification/');
                                try {
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                final urls = Uri.parse('$url/reject_notification/');
                                try {
                                  final response = await http.post(urls, body: {
                                    'nid': id_[index],
                                  });
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.cancel_rounded, color: Colors.grey[400], size: 18),
                                  SizedBox(width: 6),
                                  Text(
                                    'Reject',
                                    style: TextStyle(
